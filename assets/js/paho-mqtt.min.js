...
(function (t, q) {
    ...
    return function (t) {
        ...
        function F(a, b, c) {
            for (var k = "", e, g = b; g < b + c;) {
                ...
                if (!(128 > e)) {
                    ...
                    if (224 > e) e = 64 * (e - 192) + m; else {
                        var d =
                            a[g++] - 128;
                        if (0 > d) throw Error(f(h.MALFORMED_UTF, [e.toString(16), m.toString(16), d.toString(16)]));
                        if (240 > e) e = 4096 * (e - 224) + 64 * m + d; else {
                            var l = a[g++] - 128;
                            if (0 > l) throw Error(f(h.MALFORMED_UTF, [e.toString(16), m.toString(16), d.toString(16), l.toString(16)]));
                            if (248 > e) e = 262144 * (e - 240) + 4096 * m + 64 * d + l; else throw Error(f(h.MALFORMED_UTF, [e.toString(16), m.toString(16), d.toString(16), l.toString(16)]));
                        }
                    }
                }
        ...
        var s = t.localStorage || function () {
            ...
            f = function (a, b) {
                var c = a.text;
                if (b) for (var k, e, g = 0; g < b.length; g++) if (k = "{" + g + "}", e = c.indexOf(k), 0 < e) var h = c.substring(0, e),
                    c = c.substring(e + k.length), c = h + b[g] + c;
                return c
            }, B = [0, 6, 77, 81, 73, 115, 100, 112, 3], C = [0, 4, 77, 81, 84, 84, 4], p = function (a, b) {
                this.type = a;
                for (var c in b) b.hasOwnProperty(c) && (this[c] = b[c])
            };
        p.prototype.encode = function () {
            var a = (this.type & 15) << 4, b = 0, c = [], k = 0, e;
        ...
        var G = function (a, b) {
            ...
            this.isReset = !1;
            var c = (new p(12)).encode(), k = function (a) {
                return function () {
                    return e.apply(a)
                }
            }, e = function () {
        ...
        d.prototype.send =
            function (a) {
                ...
                var b = new p(3);
                b.payloadMessage = a;
                if (this.connected) 0 < a.qos ? this._requires_ack(b) : this.onMessageDelivered && (this._notify_msg_sent[b] = this.onMessageDelivered(b.payloadMessage)), this._schedule_message(b); else if (this._reconnecting && this.disconnectedPublishing) {
        ...
        d.prototype.startTrace = function () {
            ...
            this._trace("Client.startTrace", new Date, "1.1.0-2018-07-24T10:42:36Z")
        };
        ...
        d.prototype.store = function (a, b) {
            ...
            switch (b.type) {
                case 3:
                    ...
                    b.payloadMessage.retained && (c.payloadMessage.retained =
                        !0);
        ...
        d.prototype.restore = function (a) {
            var b = s.getItem(a), c = JSON.parse(b), d = new p(c.type, c);
            switch (c.type) {
                case 3:
        ...
        d.prototype._deframeMessages = function (a) {
            ...
            try {
                for (c = 0; c < a.length;) {
                    var d;
                    a: {
                        var e = a, g = c, m = g, n = e[g], l = n >> 4, z = n & 15, g = g + 1, x = void 0, D = 0, q = 1;
                        do {
                            if (g == e.length) {
                                d = [null, m];
                                break a
                        ...
                        if (x > e.length) d = [null, m]; else {
                            ...
                            switch (l) {
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    var m = z >> 1 & 3, s = 256 * e[g] + e[g + 1], g = g + 2, t = F(e, g, s),
                                        g = g + s;
            ...
            try {
                switch (a.type) {
                    case 2:
                        ...
                        if (0 < this._buffered_msg_queue.length) for (e =
                        ...
                        e = 0;
                        for (var g = a.length; e < g; e++) if (c = a[e], 3 == c.type && c.pubRecReceived) {
                            var m = new p(6, {messageIdentifier: c.messageIdentifier});
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        if (c = this._sentMessages[a.messageIdentifier]) if (delete this._sentMessages[a.messageIdentifier], s.removeItem("Sent:" + this._localKey + a.messageIdentifier), this.onMessageDelivered) this.onMessageDelivered(c.payloadMessage);
                        break;
                    case 5:
                        if (c = this._sentMessages[a.messageIdentifier]) c.pubRecReceived = !0, m = new p(6, {messageIdentifier: a.messageIdentifier}),
                    ...
                    case 6:
                        ...
                        var n = new p(7, {messageIdentifier: a.messageIdentifier});
        ...
        d.prototype._receivePublish = function (a) {
            switch (a.payloadMessage.qos) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    var b = new p(4, {messageIdentifier: a.messageIdentifier});
                ...
                case 2:
                    ...
                    a = new p(5, {messageIdentifier: a.messageIdentifier});
                    this._schedule_message(a);
                    break;
                default:
        ...
        d.prototype._reconnect = function () {
            ...
            this.connected || (this._reconnecting =
        ...
        d.prototype._disconnected = function (a, b) {
            ...
            if (void 0 !== a && this._reconnecting) this._reconnectTimeout = new v(this, this._reconnectInterval, this._reconnect); else if (this.sendPinger.cancel(), this.receivePinger.cancel(), this._connectTimeout &&
            (this._connectTimeout.cancel(), this._connectTimeout = null), this._msg_queue = [], this._buffered_msg_queue = [], this._notify_msg_sent = {}, this.socket && (this.socket.onopen = null, this.socket.onmessage = null, this.socket.onerror = null, this.socket.onclose = null, 1 === this.socket.readyState && this.socket.close(), delete this.socket), this.connectOptions.uris && this.hostIndex < this.connectOptions.uris.length - 1) this.hostIndex++, this._doConnect(this.connectOptions.uris[this.hostIndex]); else if (void 0 === a && (a = h.OK.code, b = f(h.OK)),
                ...
                this._doConnect(this.uri); else if (this.connectOptions.onFailure) this.connectOptions.onFailure({
        ...
        d.prototype._trace = function () {
            if (this.traceFunction) {
                ...
                b = a.join("");
                this.traceFunction({severity: "Debug", message: b})
            }
            if (null !== this._traceBuffer) for (b = 0, a = arguments.length; b < a; b++) this._traceBuffer.length ==
        ...
        var w = function (a) {
            var b;
            if ("string" === typeof a || a instanceof ArrayBuffer || ArrayBuffer.isView(a) && !(a instanceof DataView)) b = a; else throw f(h.INVALID_ARGUMENT, [a,
                "newPayload"]);
            var c, d = 0, e = !1, g = !1;
            Object.defineProperties(this, {
                payloadString: {
                    ...
                    enumerable: !0, get: function () {
                        if ("string" === typeof b) {
                            var a = new ArrayBuffer(n(b)), a = new Uint8Array(a);
                            E(b, a, 0);
                            return a
                        }
                        return b
                    ...
                    enumerable: !0, get: function () {
                        ...
                        if ("string" === typeof a) c = a; else throw Error(f(h.INVALID_ARGUMENT, [a, "newDestinationName"]));
                    }
                }, qos: {
                    enumerable: !0, get: function () {
                        return d
                    ...
                    set: function (a) {
                        if (0 === a || 1 === a || 2 === a) d = a; else throw Error("Invalid argument:" + a);
                    }
                }, retained: {
                    enumerable: !0, get: function () {
                        return e
                    }, set: function (a) {
                        if ("boolean" === typeof a) e = a; else throw Error(f(h.INVALID_ARGUMENT, [a, "newRetained"]));
                    }
                }, topic: {
                    enumerable: !0, get: function () {
                        return c
        ...
        return {
            Client: function (a, b, c, k) {
                ...
                if (2 == arguments.length) {
                    ...
                    e = a;
                    var g = e.match(/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/);
                    if (g) a = g[4] || g[2], b = parseInt(g[7]), c = g[8]; else throw Error(f(h.INVALID_ARGUMENT, [a, "host"]));
                } else {
                ...
                Object.defineProperties(this, {
                    host: {
                        ...
                        get: function () {
                            ...
                            if ("function" === typeof a) l.onConnected = a; else throw Error(f(h.INVALID_TYPE, [typeof a, "onConnected"]));
                        }
                        ...
                        get: function () {
                            ...
                            if ("function" === typeof a) l.onConnectionLost = a; else throw Error(f(h.INVALID_TYPE, [typeof a, "onConnectionLost"]));
                        }
                    }, onMessageDelivered: {
                        get: function () {
                            return l.onMessageDelivered
                        }, set: function (a) {
                            if ("function" === typeof a) l.onMessageDelivered = a; else throw Error(f(h.INVALID_TYPE, [typeof a, "onMessageDelivered"]));
                        }
                    }, onMessageArrived: {
                        get: function () {
                        ...
                        get: function () {
                            ...
                            if ("function" === typeof a) l.traceFunction = a; else throw Error(f(h.INVALID_TYPE, [typeof a, "onTrace"]));
                        }
                    }
                });
                this.connect = function (a) {
                    ...
                    if (a.willMessage) {
                        if (!(a.willMessage instanceof
                            w)) throw Error(f(h.INVALID_TYPE, [a.willMessage, "connectOptions.willMessage"]));
